...
sealed class Meals {
     ...
     * @property user user, who is ordering
    ...
    object Orders : Table("orders") {
        ...
        val user: Column<String> =
            varchar("user", 128)
                .references(Users.username, onDelete = ReferenceOption.CASCADE)
     ...
     *
     */
    object SelectionGroups : Table("selection_groups") {
        val id: Column<Int> = integer("id").autoIncrement()
        val name: Column<String> = varchar("name", 128)
